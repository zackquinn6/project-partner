-- FORCE COPY OPERATIONS TO INTERIOR PAINTING PROJECT
...
BEGIN
  ...
  LOOP
    ...
    IF FOUND THEN
      ...
      -- Count operations in standard foundation for this phase
      ...
      LOOP
        ...
        ELSE
          RAISE NOTICE '⚠️ Operation already exists: %', standard_operation.name;
        END IF;
      END LOOP;
    ELSE
