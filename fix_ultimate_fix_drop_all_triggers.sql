-- ULTIMATE FIX: Drop ALL triggers including BEFORE triggers
-- This is the most comprehensive fix - drops everything and rebuilds only what's safe

-- ============================================
-- STEP 1: Drop ALL triggers on template_operations (BEFORE, AFTER, etc.)
-- ============================================
...
-- ============================================
-- STEP 3: Recreate ONLY the safe triggers (after project creation)
-- ============================================
...
-- Recreate the sync trigger (this one is safe - it doesn't reference standard_phase_id)
