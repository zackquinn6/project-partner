-- ============================================
-- Fix: Add custom_phase_name and custom_phase_description to template_operations INSERT
-- ============================================
-- The custom_phase_metadata_check constraint requires that if is_custom_phase is true
-- (which is computed from standard_phase_id IS NULL), then custom_phase_name must not be NULL.
-- 
-- This migration updates add_custom_project_phase to include these required fields.
...
-- Recreate the function with custom_phase_name and custom_phase_description
...
BEGIN
  ...
  RAISE NOTICE '✅ Function add_custom_project_phase recreated with custom_phase_name and custom_phase_description';
END $$;
