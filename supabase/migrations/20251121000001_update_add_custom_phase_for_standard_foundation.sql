-- Update add_custom_project_phase to set is_standard: true when adding to Standard Project Foundation
-- Standard Project Foundation is the source of truth - any phase added there should be marked as standard
...
'Adds a custom phase to a project. If adding to Standard Project Foundation, automatically marks phase as is_standard: true and creates/links to standard_phases entry. Standard phases are locked and linked to all project templates.';
