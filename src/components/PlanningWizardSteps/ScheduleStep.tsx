          ...
          <div className="mt-8 pt-6 border-t">
            <div className="flex gap-3">
              <Button 
                ...
                variant="outline"
                size="lg"
                className="flex-[2] h-14 text-base font-semibold border-green-300 text-green-700 hover:bg-green-50"
              >
              ...
              <Button 
                ...
                size="lg"
                className="flex-[1] h-14 text-base font-semibold bg-blue-600 hover:bg-blue-700"
              >
