-- Ensure all functions are updated and no display_order references exist
-- Migration: 20251126000005_ensure_all_functions_updated_no_display_order.sql
--
-- This migration ensures that all database functions are properly updated
-- and there are no remaining references to display_order.

-- ============================================
-- STEP 1: Drop and recreate add_custom_project_phase to ensure it's correct
-- ============================================
...
BEGIN
  ...
  -- Insert the new phase (NO display_order column)
...
-- ============================================
-- STEP 2: Check for and drop any triggers that might reference display_order
-- ============================================
-- Drop any triggers on project_phases that might try to set display_order
...
-- ============================================
-- STEP 3: Verify no display_order references exist in functions
-- ============================================
-- This is a safety check - if any function still references display_order,
-- it will be caught when the migration runs
