...
export const PM_FOCUS_OPTIONS: {
...
}[] = [
  {
    ...
    icon: Calendar,
    colorClasses: 'border-border bg-muted hover:border-border hover:bg-muted',
  ...
  },
  {
    ...
    icon: Award,
    colorClasses: 'border-success/40 bg-success/10 hover:border-success/40 hover:bg-success/15',
    iconWrapClasses: 'bg-success/25 text-success',
  },
  {
    value: 'savings',
    ...
    icon: PiggyBank,
    colorClasses: 'border-category-3/40 bg-category-3/10 hover:border-category-3/40 hover:bg-category-3/15',
    iconWrapClasses: 'bg-category-3/25 text-category-3',
  },
  {
    value: 'all_three',
    title: 'Balanced',
    ...
    icon: Target,
    colorClasses: 'border-info/40 bg-info/10 hover:border-info/40 hover:bg-info/15',
    iconWrapClasses: 'bg-info/25 text-info',
  },
];
