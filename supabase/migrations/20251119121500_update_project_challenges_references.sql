-- Align core workflow helpers with project_challenges column
-- Recreate functions/views that previously referenced diy_length_challenges

-- 1. Revision creation should preserve project_challenges field
...
-- 2. Project run snapshots should read/write project_challenges
...
-- 3. Live templates view should expose project_challenges
