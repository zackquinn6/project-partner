    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-background p-0 hover:opacity-100 shrink-0"
        ),
        ...
        head_cell:
          "text-muted-foreground rounded-md w-full flex-1 font-normal text-[0.8rem] flex items-center justify-center",
