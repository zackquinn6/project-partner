...
export function KeyCharacteristicsExplainer({ open, onOpenChange }: KeyCharacteristicsExplainerProps) {
  return (
    <ResponsiveDialog 
      ...
      title="🥪 Priorities in Action: The PB&J Example"
      size="xlarge"
    >
      ...
      <div className="md:hidden fixed top-4 right-4 z-50">
        <Button
          ...
          className="w-8 h-8 p-0 bg-background border-2 shadow-lg"
        >
          <X className="h-4 w-4" />
        </Button>
      </div>
      ...
      <div className="space-y-6 p-6 max-h-[80vh] overflow-y-auto">
        <div className="bg-primary/10 p-4 rounded-lg">
          <p className="text-sm text-muted-foreground leading-relaxed">
            Priorities are how we personalize our projects to each builder. We tailor detail to skill level: first‑timers get the full play‑by‑play, while seasoned DIYers aren't stuck reading what a miter saw looks like.
          </p>
        </div>
        ...
        <Card className="border-primary">
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <div className="bg-primary/10 p-4 rounded-lg mt-4">
              <p className="font-medium mb-2">This is the essence of Priorities:</p>
            ...
            <p className="font-medium text-primary">
              Priorities aren't about dumbing things down—they're about precision at the right level of detail.
            </p>
          </CardContent>
        </Card>
