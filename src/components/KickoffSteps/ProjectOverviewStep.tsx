        ...
        <CardContent className="space-y-3 sm:space-y-4 p-3 sm:p-4 md:p-6">
          ...
          <div className="bg-background pt-3 sm:pt-4 border-t mt-3 sm:mt-4 pb-2 sticky bottom-0">
            {!isCompleted && <div className="flex gap-2">
                <Button onClick={handleCancelProject} variant="outline" className="w-1/4 border-red-300 text-red-700 hover:bg-red-50 text-xs sm:text-sm h-9 sm:h-10">
            ...
            {isCompleted && <div className="w-full p-2 bg-green-50 border border-green-200 rounded-lg text-center">
