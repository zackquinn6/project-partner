...
export const tileInstallationMaterials: LibraryMaterial[] = [
  {
    id: 'floor-tiles',
    name: 'Ceramic/Porcelain Floor Tiles',
...
export const createFallbackTileProject = (): Project => {
  ...
  // Ensure standard phases are included for new projects
