...
-- This migration ensures the profiles table is created
-- even if the previous migration didn't execute properly
-- =====================================================
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'profiles') THEN
    RAISE NOTICE '✅ profiles table verified and created successfully';
  ELSE
