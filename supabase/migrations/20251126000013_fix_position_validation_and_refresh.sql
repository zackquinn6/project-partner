-- Fix position validation and prevent double refresh issues
-- Migration: 20251126000013_fix_position_validation_and_refresh.sql
--
-- This migration:
-- 1. Adds position validation to prevent custom phases from using position rules that conflict with standard phases
-- 2. Ensures position uniqueness (no two phases can have the same position_rule/position_value combination)
